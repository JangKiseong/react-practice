...
module.exports = {
  ...
  entry: {
    dev: "./src/index.js",
  }, // 웹 자원을 변환하기 위해 필요한 최초 진입점 이자 .js 경로
  output: {
    // bundled compiled 파일, 하나로 묶은 결과물을 반환할 위치 및 파일 이름
  ...
  devServer: {
    ...
    historyApiFallback: {
      index: "/dev.html",
      disableDotRule: true,
    }, // '/'경로 이외의 Router에 설정해준 경로를 접근 할 수 있도록 해줌
    port: 4751,
    hot: true,
    host: "localhost",
    compress: true,
  ...
  target: "web",
  plugins: [
    // webpack의 기본적인 동작 외 추가적인 기능을 제공하는 속성
    new HtmlWebpackPlugin({
      title: "react_practice", // title tag
      filename: "dev.html", // output file name
      template: "./src/index.html", // 생성한 템플릿 파일
      inject: "head", // script 위치 결정
      scriptLoading: "defer",
      base: "http://localhost:4751",
